...
When $t > 0$ we call the index of the opinion with the largest population $max(t)$. The amount of agents of the largest state at time $t$ we define as $x_{max}(t)$. 
