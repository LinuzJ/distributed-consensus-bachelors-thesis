...
The main results that Angluin presents in \cite{angluinSimplePopulationProtocol2008} were briefly described in \ref{angluinIntroduction}. By the proofs presented in \cite{angluinSimplePopulationProtocol2008}, a high-probability bound of the total interactions done before reaching convergence is presented in the following theorem.
...
The parameter $c$ is a fixed positive error parameter $c > 0$. The convergence time $\tau$ will be the sum of all indicator variable sums at the time of $\tau$, $\tau = S^c_\tau + S^b_\tau + S^x_\tau + S^y_\tau$. This is
