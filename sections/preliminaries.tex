...
\subsection{Big O notation}
 ...
 \begin{Definition}
 \inlineMath{f(n) = O(g(n))} describes an equation where there exists positive constants 
 \inlineMath{c} and \inlineMath{k}, such that \inlineMath{0 \leq f(n) \leq c*g(n) \: \forall \: n \geq k}
 \end{Definition}
...
Let this system be a graph \inlineMath{G = (E, N)}, where \inlineMath{N} represents the nodes, meaning the computing entities of the system and \inlineMath{E} represents the edges in the system that make up the communication links between the edges.
