...
\fda{the otbher drawback is that it depends on the input size $n$: in many cases, nodes should NOT know how many they are before the process starts}
...
\fda{We have to modify the occurrences of ``states'' in a coherent way to what I said before, specifying whether they are opinions}
